<?php
    $relate_count = justhome_get_config('number_blog_related', 3);
    $relate_columns = justhome_get_config('related_blog_columns', 3);
...
<div class="wrapper-posts-related">
    <div class="<?php echo apply_filters( 'justhome_blog_content_class', 'container' ); ?>">
        <div class="related-posts">
            <h4 class="title text-center">
                <?php esc_html_e( 'Related Posts', 'justhome' ); ?>
            </h4>
