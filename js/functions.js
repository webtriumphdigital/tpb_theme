(function ($) {
    ...
    ApusThemeCore.prototype = {
        ...
        initSlick: function(element) {
            ...
            element.each( function(){
                var config = {
                    ...
                    slidesToShow: 4,
                    slidesToScroll: 4,
                    prevArrow:"<button type='button' class='slick-arrow slick-prev'><i class='ti-angle-left'></i></span><span class='textnav'>"+ justhome_ajax.previous +"</span></button>",
                    nextArrow:"<button type='button' class='slick-arrow slick-next'><span class='textnav'>"+ justhome_ajax.next +"</span><i class='ti-angle-right'></i></button>",
                };
        ...
        popupImage: function() {
            ...
            $('.btn-login-show-popup').magnificPopup({
        ...
        initMobileMenu: function() {
            ...
            var mobilemenu = $("#navbar-offcanvas").mmenu({
                offCanvas: true,
                navbar: {
                    title: justhome_ajax.mmenu_title
                },
                onClick: {
                    close: false
                }
    ...
    jQuery(window).on("elementor/frontend/init", function() {
        ...
        elementorFrontend.hooks.addAction( "frontend/element_ready/apus_element_blog_single_related.default",
            function($scope) {
                apusthemecore_init.initSlick($scope.find('.slick-carousel'));
            }
        );
        ...
        elementorFrontend.hooks.addAction( "frontend/element_ready/apus_element_detail_property_related.default",
            function($scope) {
                apusthemecore_init.initSlick($scope.find('.slick-carousel'));
            }
        );

        elementorFrontend.hooks.addAction( "frontend/element_ready/apus_element_detail_property_gallery.default",
            function($scope) {
                apusthemecore_init.initSlick($scope.find('.slick-carousel'));
            }
        );
