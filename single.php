...
?>
	...
	<section id="main-container" class="main-content-detail <?php echo apply_filters( 'justhome_blog_content_class', 'container' ); ?> inner">
	...
	<?php if ( justhome_get_config('show_blog_related', false) ): ?>
		<?php get_template_part( 'template-posts/single/posts-related' ); ?>
	<?php endif; ?>
<?php get_footer(); ?>