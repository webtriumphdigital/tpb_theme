	...
	<div class="row flex-middle-sm">
		...
		<div class="col-xs-7 col-sm-5 col-lg-6">
		    <div class="wrapper-info">
	            ...
	            <div class="product-excerpt">
		           <?php echo justhome_substring( get_the_excerpt(), 50, '...' ); ?>
		        </div>
			</div>
		</div> 
		<div class="col-12 col-sm-4 col-lg-3">
			<div class="left-infor">
				<?php 
					do_action('justhome_list_shipping_info');
					add_action( 'justhome_list_price', 'woocommerce_template_loop_price', 10 );
					do_action('justhome_list_price');
				?>
