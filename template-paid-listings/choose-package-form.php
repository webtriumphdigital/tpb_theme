...
?>
<form method="post" id="property_package_selection" class="clearfix">
	<?php if ( empty($property_id) || WP_RealEstate_User::is_user_can_edit_property( $property_id ) ) { ?>
		<div class="property_property_packages_title">
			...
			<h2 class="title_package_heading hidden"><?php esc_html_e( 'Choose a package', 'justhome' ); ?></h2>
		</div>
	...
	<?php } else { ?>
		<div class="text-warning box-white-dashboard">
			<?php esc_html_e('Sorry, you can\'t post a property.', 'justhome'); ?>
		</div>
	<?php } ?>
</form>