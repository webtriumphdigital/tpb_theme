...
class Justhome_Elementor_Elementor_Template extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Load Elementor Template', 'justhome' );
    }
    ...
    protected function render() {
        ...
        if ( '0' !== $item_template_id ) {
            ...
            $item_template_id = justhome_get_lang_post_id($item_template_id, 'elementor_library');
    ...
    public function no_template_content_message() {
        return '<div class="no-template-message"><span>' . esc_html__( 'The element are working. Please, note, that you have to add a template to the library in order to be able to display it inside the section.', 'justhome' ) . '</span></div>';
    }
...
Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Elementor_Template );
