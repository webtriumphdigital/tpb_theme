...
class Justhome_Elementor_Widget_Blog_Single_Related extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_blog_single_related';
	}

	public function get_title() {
		return esc_html__( 'Blog Single:: Related', 'justhome' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'title', [
                ...
                'default' => esc_html__( 'Related Posts' , 'justhome' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => array(
                    'inner-grid' => esc_html__('Item 1', 'justhome'),
                    'inner-grid-v2' => esc_html__('Item 2', 'justhome'),
                ),
                'default' => 'inner-grid',
                'condition' => [
	...
	protected function render() {
		...
		?>
				...
				<?php
				    ...
				    $loop = new WP_Query( $args );
				    if ( $loop->have_posts() ): ?>
                        <div class="wrapper-posts-related <?php echo esc_attr($el_class); ?>">
                            <div class="container">
                                <?php if ( !empty($title) ) { ?>
                                    <h3 class="title text-center"><?php echo esc_html($title); ?></h3>
                                <?php } ?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Blog_Single_Related );
