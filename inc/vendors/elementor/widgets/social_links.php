...
class Justhome_Elementor_Social_Links extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Social Links and Information', 'justhome' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__( 'Social Icons', 'justhome' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'special' => esc_html__('Special', 'justhome'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->start_controls_section(
            'section_title_style',
            [
                'label' => esc_html__( 'Social', 'justhome' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
...
Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Social_Links );