...
class Justhome_Elementor_Widget_Detail_Property_Overview extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_property_overview';
	}

	public function get_title() {
		return esc_html__( 'Property Details:: Overview', 'justhome' );
	}
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'st_center' => esc_html__('Center', 'justhome'),
                ),
                'default' => ''
            ]
        );
	...
	protected function render() {
		...
		if ( !empty($post_id) && !empty($items) ) {
			...
			<div class="property-detail-detail <?php echo esc_attr($el_class); ?>">
				<ul class="list list-overview d-flex flex-wrap <?php echo esc_attr($style); ?>">
	...
	private function render_meta_field($item, $post_id, $field_name) {
		...
		<li class="d-flex align-items-center">
			...
			<div class="details flex-grow-1">
				<div class="value">
					<?php
					$field_name = !empty($item['custom_title']) ? $item['custom_title'] : '';
					if ( $field_name ) {
						?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Property_Overview );