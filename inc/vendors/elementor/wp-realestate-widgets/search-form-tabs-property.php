...
class Justhome_Elementor_RealEstate_Search_Form_Tabs extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Properties Search Form Tabs', 'justhome' );
    }
	...
	protected function register_controls() {
        ...
        $tabs = [0 => esc_html__('All Conditions', 'justhome')];
        if ( !empty($statues) ) {
        ...
        $tab_repeater->add_control(
            'tab_status',
            [
                'label' => esc_html__( 'Status', 'justhome' ),
        ...
        $this->start_controls_section(
            'content_section_top',
            [
                'label' => esc_html__( 'Search Form Tabs', 'justhome' ),
        ...
        $this->add_control(
            'active_tab',
            [
                'label' => esc_html__( 'Activate Tab', 'justhome' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => $tabs,
                'default' => 0
            ]
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Search Form Fields ', 'justhome' ),
                'tab' => Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .tab-list' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'more_options',
            [
                'label' => esc_html__( 'Action Tab', 'justhome' ),
        ...
        $this->start_controls_tabs( 'tabs_nav_style' );
            ...
            $this->add_control(
                'tab_bg_color',
                [
                    'label' => esc_html__( 'BG Color', 'justhome' ),
                    'type' => Elementor\Controls_Manager::COLOR,
                    'selectors' => [
        ...
        $this->add_control(
            'tab_line_color',
            [
                'label' => esc_html__( 'Line Color', 'justhome' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'more_item_options',
            [
                'label' => esc_html__( 'Tab Item', 'justhome' ),
                'type' => Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .nav-tabs [type="radio"] + span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .nav-tabs li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_RealEstate_Search_Form_Tabs );