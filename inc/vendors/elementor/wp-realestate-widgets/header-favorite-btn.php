...
class Justhome_Elementor_Favorite_Btn extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header Favorite Button', 'justhome' );
    }
	...
	protected function render() {
        ...
        <div class="widget-favorites-btn <?php echo esc_attr($el_class); ?>">
            <a class="btn-favorites" href="<?php echo esc_url( get_permalink( $favorite_properties_page_id ) ); ?>" title="<?php esc_attr_e('Favorite', 'justhome'); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Favorite_Btn );