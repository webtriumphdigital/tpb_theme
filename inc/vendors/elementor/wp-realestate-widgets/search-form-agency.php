...
class Justhome_Elementor_RealEstate_Agency_Search_Form extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_element_realestate_agenciessearch_form';
    }

	public function get_title() {
        return esc_html__( 'Apus Agencies Search Form', 'justhome' );
    }
	...
	protected function register_controls() {
        ...
        $fields = WP_RealEstate_Agency_Filter::get_fields();
	...
	protected function render() {
        ...
        $search_page_url = WP_RealEstate_Mixes::get_agencies_page_url();

        justhome_load_select2();

        $filter_fields = WP_RealEstate_Agency_Filter::get_fields();
        $instance = array();
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_RealEstate_Agency_Search_Form );