...
class Justhome_Elementor_Submit_Btn extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header Submit Button', 'justhome' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'hover_animation',
            [
                'label' => esc_html__( 'Hover Animation', 'justhome' ),
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Submit_Btn );