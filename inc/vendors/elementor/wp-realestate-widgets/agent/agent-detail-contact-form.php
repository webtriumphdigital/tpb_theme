...
class Justhome_Elementor_Widget_Detail_Agent_Contact_Form extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_agent_contact_form';
	}

	public function get_title() {
		return esc_html__( 'Agent Details:: Contact Form', 'justhome' );
	}
	...
	protected function render() {
		...
		if ( !empty($post) ) {
	        if ( $contact_form ) {
				?>
				<div class="agent-detail-element agent-detail-contact-form <?php echo esc_attr($el_class); ?>">
					<?php
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Agent_Contact_Form );
