...
class Justhome_Elementor_Widget_Detail_Agency_Title extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_agency_title';
	}

	public function get_title() {
		return esc_html__( 'Agency Details:: Title', 'justhome' );
	}
	...
	protected function render() {
		...
		if ( $post_id ) {
			?>
			<div class="agency-detail-title <?php echo esc_attr($el_class); ?>">
				<?php
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Agency_Title );
