...
class Justhome_Elementor_Widget_Agency_Archive_Maps extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_agency_archive_maps';
	}

	public function get_title() {
		return esc_html__( 'Agency Archive:: Maps', 'justhome' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} #agencies-google-maps' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
	...
	protected function render() {
        ...
        extract( $settings );
		?>
		<div class="agency-maps <?php echo esc_attr($el_class); ?>">
            ...
            <?php } ?>
			<div id="agencies-google-maps" class="<?php echo esc_attr( ($select_height == "full")?'fix-map':'' ) ?>"></div>
		</div>
		<?php
	}
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Agency_Archive_Maps );
