...
class Justhome_Elementor_Logo extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header Logo', 'justhome' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'image',
            [
                'label' => esc_html__( 'Main Logo', 'justhome' ),
...
Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Logo );