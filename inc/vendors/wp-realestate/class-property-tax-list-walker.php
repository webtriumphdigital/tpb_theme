<?php
/**
 * Justhome_Property_Tax_List_Walker class
 *
...
if ( class_exists( 'Justhome_Property_Tax_List_Walker', false ) ) {
	return;
}
 ...
 */
class Justhome_Property_Tax_List_Walker extends Walker {
	 ...
	 * @var string
	 */
	// public $tree_type = 'property_type';
	...
	public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		$output .= '"><a href="' . get_term_link( $cat_id, $cat->taxonomy ) . '">' . apply_filters( 'list_product_cats', $cat->name, $cat ) . '</a>';
