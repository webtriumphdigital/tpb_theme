        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'grid-v5' => esc_html__('Grid V5', 'homeo'),
                    'grid-v6' => esc_html__('Grid V6', 'homeo'),
                ),
                'default' => 'grid'
            ]
        );
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    ...
    Elementor\Plugin::instance()->widgets_manager->register( new Homeo_Elementor_RealEstate_Properties_Tabs );
}