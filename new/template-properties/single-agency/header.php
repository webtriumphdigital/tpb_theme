...
$fax = homeo_agency_display_fax($post, 'title', false);
$address = homeo_agency_display_full_location($post, 'no-title', false);
$phone = homeo_agency_display_phone($post, 'title', false);
$email = homeo_agency_display_email($post, 'title', false);
$website = homeo_agency_display_website($post, 'title', false);
