...
<article id="post-<?php the_ID(); ?>" <?php post_class('property-single-layout property-single-v3'); ?>>
	...
	<div class="<?php echo apply_filters('homeo_property_content_class', 'container');?>">
		<?php echo WP_RealEstate_Template_Loader::get_template_part( 'single-property/header-v3' ); ?>
	</div>

	<?php echo WP_RealEstate_Template_Loader::get_template_part( 'single-property/gallery-v3', array('gallery_size' => 'homeo-gallery-v3')  ); ?>
		...
		<div class="content-property-detail content-property-detail-v3">
			...
			<div class="row">
				<div class="col-xs-12 property-detail-main col-md-<?php echo esc_attr( is_active_sidebar( 'property-single-sidebar' ) ? 8 : 12); ?>">
					...
					<?php
					if ( homeo_get_config('show_property_nearby_google_places', false) ) {
