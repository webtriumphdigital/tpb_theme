    		...
    		<div class="col-xs-6">
			    <div class="date-from-wrapper">
				    ...
				    <input type="text" name="<?php echo esc_attr($name); ?>[from]" class="form-control field-datetimepicker"
				           ...
				           id="<?php echo esc_attr( $args['widget_id'] ); ?>_<?php echo esc_attr($key); ?>" placeholder="<?php echo esc_attr(!empty($field['placeholder']) ? $field['placeholder'] : ''); ?> <?php esc_attr_e('Form', 'justhome'); ?>">
				</div>
			</div>
			<div class="col-xs-6">
				<div class="date-to-wrapper">
				    ...
				    <input type="text" name="<?php echo esc_attr($name); ?>[to]" class="form-control field-datetimepicker"
				           value="<?php echo esc_attr($selected_to); ?>" placeholder="<?php echo esc_attr(!empty($field['placeholder']) ? $field['placeholder'] : ''); ?> <?php esc_attr_e('To', 'justhome'); ?>">
				</div>
			</div>
		</div>
	</div>
