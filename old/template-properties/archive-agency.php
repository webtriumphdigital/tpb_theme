...
if ( isset( $_REQUEST['load_type'] ) && WP_RealEstate_Mixes::is_ajax_request() ) {
	...
	$sidebar_configs = justhome_get_agencies_layout_configs();

	justhome_render_breadcrumbs();
	?>
	<section id="main-container" class="main-content  <?php echo apply_filters('justhome_agency_content_class', 'container');?> inner">
			...
			<div id="main-content" class="col-sm-12 <?php echo esc_attr($sidebar_configs['main']['class']); ?>">
				<div id="main" class="site-main layout-type-grid" role="main">
					...
					<?php
						...
						echo WP_RealEstate_Template_Loader::get_template_part('loop/agency/pagination', $args);
					?>
