...
<article <?php post_class('map-item property-list property-item'); ?> <?php justhome_property_item_map_meta($post); ?> <?php justhome_property_display_gallery($post, 'justhome-property-list'); ?>>
    <div class="d-md-flex align-items-center">
        ...
        <div class="property-information flex-grow-1">
            ...
            <?php if(get_the_excerpt()){ ?>
                <div class="description d-none d-lg-block"><?php echo justhome_substring( get_the_excerpt(),16, '...' ); ?></div>
            <?php } ?>
            <?php
