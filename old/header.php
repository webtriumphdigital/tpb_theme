...
<body <?php body_class(); ?>>
<?php if ( justhome_get_config('preload', true) ) {
	$preload_icon = justhome_get_config('media-preload-icon');
	$styles = array();
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php
		$header = apply_filters( 'justhome_get_header_layout', justhome_get_config('header_type') );
		if ( !empty($header) ) {
			justhome_display_header_builder($header);
		} else {
