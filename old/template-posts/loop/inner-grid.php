<?php 
global $post;
$thumbsize = !isset($args['thumbsize']) ? justhome_get_config( 'blog_item_thumbsize', '930x500' ) : $args['thumbsize'];
...
<article <?php post_class('post post-layout post-grid'); ?>>
    <div class="list-inner">
        ...
        <div class="col-content">
            ...
            <?php } ?>
            <div class="description d-xl-block d-none"><?php echo justhome_substring( get_the_excerpt(),25, '...' ); ?></div>
            <div class="description d-xl-none d-block"><?php echo justhome_substring( get_the_excerpt(),15, '...' ); ?></div>
            <div class="readmore">
