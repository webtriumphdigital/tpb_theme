<?php 
global $post;
$thumbsize = !isset($args['thumbsize']) ? justhome_get_config( 'blog_item_thumbsize', '330x330' ) : $args['thumbsize'];
...
<article <?php post_class('post post-layout post-list-item'); ?>>
    <div class="d-flex">
        ...
        ?>
        <div class="col-content flex-grow-1 d-flex">
            <div class="flex-column d-flex w-100 justify-content-center">
                <div class="top-detail-info d-md-flex flex-wrap align-items-center d-none">
                ...
                <?php } ?>
                <div class="description d-md-block d-none"><?php echo justhome_substring( get_the_excerpt(),32, '...' ); ?></div>
                <div class="description d-md-none d-block"><?php echo justhome_substring( get_the_excerpt(),8, '...' ); ?></div>
                <div class="readmore d-md-block d-none">
