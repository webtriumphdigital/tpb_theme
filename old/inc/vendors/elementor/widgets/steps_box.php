...
class Justhome_Elementor_Steps_Box extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Steps Box', 'justhome' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Steps Box', 'justhome' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'style1' => esc_html__('Horizontal', 'justhome'),
                    'style2' => esc_html__('Vertical', 'justhome'),
                ),
                'default' => 'style1'
            ]
        );
                            ...
                            <div class="item-step position-relative <?php echo trim($style); ?>">
                                 <div class="top-inner">
                                    ...
                                    if ( $item['image_icon'] == 'image' ) {
                                        ...
                                        $html .= '<div class="step-box-image icon">'.$icon_html.'</div>';
                                    }
                                $html .= '</div>';
                                if ( $has_content ) {
...
Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Steps_Box );