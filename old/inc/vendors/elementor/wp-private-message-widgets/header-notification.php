...
class Justhome_Elementor_User_Header_Notification extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Message Notification', 'justhome' );
    }
	...
	protected function render() {
        ...
        <div class="message-top <?php echo esc_attr($el_class); ?>">
            <a class="message-notification d-flex align-items-center justify-content-center" href="<?php echo esc_url($page_url); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_User_Header_Notification );