...
class Justhome_Elementor_Widget_Agent_Archive_Sortby extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_agent_archive_sortby';
	}

	public function get_title() {
		return esc_html__( 'Agent Archive:: Sort By', 'justhome' );
	}
	...
	protected function render() {
		...
		?>
		<div class="agents-ordering <?php echo esc_attr($el_class); ?>">
			<form class="agents-ordering" method="get" action="<?php echo WP_RealEstate_Mixes::get_agents_page_url(); ?>">
				<?php if ( $title ) { ?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Agent_Archive_Sortby );
