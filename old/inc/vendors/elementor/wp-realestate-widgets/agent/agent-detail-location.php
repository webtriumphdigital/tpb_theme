...
class Justhome_Elementor_Widget_Detail_Agent_Location extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_agent_location';
	}

	public function get_title() {
		return esc_html__( 'Agent Details:: Maps Location', 'justhome' );
	}
	...
	protected function render() {
		...
		if ( !empty($post) ) {
	        ...
	        ?>
			<div class="agent-detail-location <?php echo esc_attr($el_class); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Agent_Location );
