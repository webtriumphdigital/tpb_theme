...
class Justhome_Elementor_Widget_Detail_Property_Title extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_property_title';
	}

	public function get_title() {
		return esc_html__( 'Property Details:: Title', 'justhome' );
	}
	...
	protected function render() {
		...
		if ( $post_id ) {
			?>
			<div class="property-detail-title <?php echo esc_attr($el_class); ?>">
				<?php
				$this->add_render_attribute( 'title', 'class', 'detail-heading-title' );
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Property_Title );
