...
class Justhome_Elementor_Widget_Detail_Property_Favorite_Button extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_property_favorite_button';
	}

	public function get_title() {
		return esc_html__( 'Property Details:: Favorite Button', 'justhome' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => esc_html__( 'Favorite', 'justhome' ),
			]
		);
	...
	protected function render() {
		...
		if ( !empty($post_id) ) {
	        ?>
			<div class="property-detail-favorite action-item <?php echo esc_attr($el_class); ?>">
				<?php
			        if ( justhome_get_config('listing_enable_favorite', true) ) {
                        ...
                        WP_RealEstate_Favorite::display_favorite_btn($post_id, $args);
                    }
				?>
			</div>
			<?php
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Property_Favorite_Button );
