...
class Justhome_Elementor_Widget_Detail_Property_Related extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_property_related';
	}

	public function get_title() {
		return esc_html__( 'Property Details:: Related', 'justhome' );
	}
	...
	protected function render() {
		...
		if ( !empty($post) ) {
	        ?>
			<div class="property-detail-related <?php echo esc_attr($el_class); ?>">
				<?php
				...
				if( $loop->have_posts() ):
		            ...
		            <div class="widget-properties <?php echo esc_attr($layout_type.' item-'.$property_item_style); ?> <?php echo esc_attr($el_class); ?>">
	                    ...
	                    <?php if ( $title ) { ?>
                            <h4 class="title-related-properties"><?php echo esc_html($title); ?></h4>
                        <?php } ?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Property_Related );
