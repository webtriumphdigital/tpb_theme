...
class Justhome_Elementor_Widget_Detail_Agency_Properties extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_agency_properties';
	}

	public function get_title() {
		return esc_html__( 'Agency Details:: Properties', 'justhome' );
	}
	...
	protected function render() {
		...
		if ( !empty($post) ) {
				...
				if( $loop->have_posts() ):
		            ...
		            ?>
                    <div class="member-detail-properties agency-detail-properties <?php echo esc_attr($el_class); ?>">
    		            ...
    		            <div class="widget-properties <?php echo esc_attr($layout_type); ?> <?php echo esc_attr($el_class); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Agency_Properties );