...
class Justhome_Elementor_Widget_Detail_Agency_Agents extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_detail_agency_agents';
	}

	public function get_title() {
		return esc_html__( 'Agency Details:: Agents', 'justhome' );
	}
	...
	protected function render() {
		...
		if ( !empty($post) ) {
	        ?>
			<div class="agency-detail-agents <?php echo esc_attr($el_class); ?>">
				<?php
				...
				if( !empty($loop) && $loop->have_posts() ):
		            ...
		            ?>
		            <div class="widget-agents member-detail-properties <?php echo esc_attr($el_class); ?>">
		                <?php if ( !empty($title) ) { ?>
                            <div class="top-info">
                                <h4 class="title m-0">
                                    <?php echo trim($title); ?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Detail_Agency_Agents );
