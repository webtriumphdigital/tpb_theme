...
class Justhome_Elementor_Widget_Dashboard_Property_Count extends Elementor\Widget_Base {

	public function get_name() {
		return 'apus_element_dashboard_property_count';
	}

	public function get_title() {
		return esc_html__( 'Dashboard:: Property Count', 'justhome' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'status',
			[
				'label' => esc_html__( 'Property Status', 'justhome' ),
				'type' => Elementor\Controls_Manager::SELECT,
				'options' => array(
					'publish' => esc_html__('Publish', 'justhome'),
					'pending' => esc_html__('Pending', 'justhome'),
				),
				'default' => 'publish',
			]
		);
	...
	protected function render() {
		...
		?>
		<div class="dashboard-property-count <?php echo esc_attr($el_class); ?>">
			<?php
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_Widget_Dashboard_Property_Count );
