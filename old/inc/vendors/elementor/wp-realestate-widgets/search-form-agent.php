...
class Justhome_Elementor_RealEstate_Agent_Search_Form extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Agents Search Form', 'justhome' );
    }
...
Elementor\Plugin::instance()->widgets_manager->register( new Justhome_Elementor_RealEstate_Agent_Search_Form );