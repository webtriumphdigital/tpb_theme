...
if ( class_exists( 'WP_Customize_Control' ) ) {
    class Justhome_WP_Customize_Radio_Image_Control extends WP_Customize_Control {
        public $type = 'justhome_radio_image';
    ...
    class Justhome_WP_Customize_Heading_Control extends WP_Customize_Control {
        public $type = 'justhome_heading';
