...
class Justhome_Widget_Recent_Post extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_post',
            esc_html__('Apus Recent Posts Widget', 'justhome'),
            array( 'description' => esc_html__( 'Show list of recent post', 'justhome' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                <?php echo esc_html__('Type:', 'justhome' ); ?>
            </label>
            <br>
...
call_user_func( implode('_', array('register', 'widget') ), 'Justhome_Widget_Recent_Post' );