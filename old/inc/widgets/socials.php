...
class Justhome_Widget_Socials_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'justhome'),
            array( 'description' => esc_html__( 'Socials for website.', 'justhome' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'justhome-admin', get_template_directory_uri().'/js/admin.js', array( 'jquery' ), '1.0', true );
    }
    ...
    public function form( $instance ) {
        ...
        $styles = array(
            esc_html__('Style 1', 'justhome') => 'style1',
            esc_html__('Style 2', 'justhome') => 'style2'
        );
    ...
    <div class="apus_socials">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'socials' )); ?>"><?php esc_html_e('Select socials:', 'justhome'); ?></label>
            <br>
        <?php
...
call_user_func( implode('_', array('register', 'widget') ), 'Justhome_Widget_Socials_Widget' );