...
*/
get_header();
$sidebar_configs = justhome_get_page_layout_configs();
global $post;
?>
<section class="page-dashboard <?php echo esc_attr(get_post_meta( $post->ID, 'apus_page_layout', true )); ?>">
	<section id="main-container" class="inner-dashboard <?php echo apply_filters('justhome_page_content_class', 'container');?>">
