...
<article <?php post_class('map-item property-grid-v1 property-item'); ?> <?php justhome_property_item_map_meta($post); ?> <?php justhome_property_display_gallery($post, 'justhome-property-grid'); ?>>
