...
<article <?php post_class('map-item property-grid-v2 property-item'); ?> <?php justhome_property_item_map_meta($post); ?> <?php justhome_property_display_gallery($post, 'justhome-property-grid-lg'); ?>>

    <div class="property-thumbnail-wrapper position-relative">
            <?php justhome_property_display_image( $post, 'justhome-property-grid-lg' ); ?>
            <?php
    ...
    <div class="property-information">
        ...
        <div class="d-flex flex-wrap align-items-center information-bottom">
            ...
            ?>
                <div class="property-metas d-flex flex-wrap ms-auto">
                    <?php
                        echo trim($beds);
                        echo trim($baths);
                        echo trim($lot_area);
