...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="the-comment">
		<div class="clearfix">
			<div class="avatar">
				<?php echo justhome_get_avatar( $comment->user_id, '90', '' ); ?>
			</div>
			<div class="comment-box">
				<div class="clearfix">
					<div class="star-rating" title="<?php echo sprintf( esc_attr__( 'Rated %d out of 5', 'justhome' ), $rating ) ?>">
					...
					<?php if ( $comment->comment_approved == '0' ) : ?>
						<span class="date"><em><?php esc_html_e( 'Your comment is awaiting approval', 'justhome' ); ?></em></span>
					<?php else : ?>
						<span class="date">
