...
<div class="saved-search-form-btn">
	<a href="#saved-search-form-btn-wrapper" class="btn-saved-search"><i class="flaticon-heart"></i> <?php esc_html_e('Save Search', 'justhome'); ?></a>
</div>
<div id="saved-search-form-btn-wrapper" class="saved-search-form-wrapper mfp-hide" data-effect="fadeIn">
	<form method="get" action="" class="saved-search-form">
		...
		<div class="form-group no-margin">
			<button class="button btn btn-theme"><?php esc_html_e('Save', 'justhome'); ?></button>
		</div><!-- /.form-group -->
