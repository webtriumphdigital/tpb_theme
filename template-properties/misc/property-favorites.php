...
?>
<h1 class="title-profile"><?php esc_html_e( 'Favorite', 'justhome' ) ; ?></h1>
<?php
		...
		<div class="box-white-dashboard pb-0">
				...
				<div class="search-properties-favorite-form widget-search">
					<form action="" method="get">
						<div class="input-group">
							<button class="search-submit btn btn-search" name="submit"><i class="flaticon-magnifiying-glass"></i></button>
			...
			<div class="row">
				<?php while ( $properties->have_posts() ) : $properties->the_post();
					?>
					<div class="col-12 col-xl-6 property-item-favorite property-favorite-wrapper">
...
<?php } else { ?>
	<div class="not-found box-white-dashboard"><?php esc_html_e('No properties found.', 'justhome'); ?></div>
<?php } ?>