...
<div class="clearfix">
	...
	<h3 class="title-profile"><?php echo esc_html__('My Saved Search','justhome') ?></h3>
		...
		<div class="box-white-dashboard">
					...
					<div class="search-properties-saved-search-form widget-search">
						<form action="" method="get">
							<div class="input-group">
								<input type="text" placeholder="<?php echo esc_html__( 'Search ...', 'justhome' ); ?>" class="form-control" name="search" value="<?php echo esc_attr(isset($_GET['search']) ? $_GET['search'] : ''); ?>">
			...
			<div class="table-responsive">
				<table class="property-table user-transactions">
					<thead>
						<tr>
							<td class="title"><?php esc_html_e('Title', 'justhome'); ?></td>
							<td class="alert-query"><?php esc_html_e('Saved Search Query', 'justhome'); ?></td>
							<td class="property-number"><?php esc_html_e('Number Properties', 'justhome'); ?></td>
							<td class="property-times"><?php esc_html_e('Times', 'justhome'); ?></td>
							<td class="property-actions"><?php esc_html_e('Actions', 'justhome'); ?></td>
						</tr>
					</thead>
					<tbody>
						...
						<tr <?php post_class('saved-search-wrapper'); ?>>
							...
							<td>
								<div class="property-found">
						            <?php echo sprintf(esc_html__('Properties found %d', 'justhome'), intval($count_properties) ); ?>
						        </div>
							</td>
							<td>
							...
							<td>
								<a href="javascript:void(0)" class="btn-remove-saved-search btn-action-icon deleted" data-saved_search_id="<?php echo esc_attr($saved_search_id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-realestate-remove-saved-search-nonce' )); ?>"><i class="flaticon-delete"></i></a>
							</td>
						</tr>
	...
	<?php } else { ?>
		<div class="not-found box-white-dashboard"><?php esc_html_e('No property alert found.', 'justhome'); ?></div>
	<?php } ?>
</div>